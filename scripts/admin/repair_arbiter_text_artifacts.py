...
def _repair_handle(handle: str) -> None:
    packet_path = PROJECT_ROOT / "artifacts" / "brand_arbiter" / handle / "intelligence_packet.json"
    report_path = PROJECT_ROOT / "artifacts" / "brand_arbiter" / handle / "arbiter_report.md"
    ...
    evidence_bundle_path = PROJECT_ROOT / "artifacts" / "brand_intelligence" / handle / "evidence_bundle.json"
    ...
    manual_packet_path = PROJECT_ROOT / "artifacts" / "supervisor" / "codex_manual_packets" / f"codex_manual__brand_arbiter__{handle}.json"
