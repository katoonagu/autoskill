...
def discover_snapshots(brands_dir: Path, preserved_run_tables: list[Path] | None = None) -> list[Snapshot]:
    ...
    backup_root = PROJECT_ROOT / "artifacts" / "instagram_brand_search" / "_relaunch_backups"
    ...
    playwright_root = PROJECT_ROOT / "artifacts" / "playwright"
...
def load_brand_dossier_metrics() -> dict[str, dict[str, int]]:
    dossiers_root = PROJECT_ROOT / "artifacts" / "brand_intelligence"
