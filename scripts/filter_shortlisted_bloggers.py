...
def main() -> int:
    ...
    parser.add_argument(
        "--md",
        default="output/instagram_brand_search/following/shortlisted_bloggers_for_phase1.md",
        help="Path to shortlisted markdown file.",
    )
    parser.add_argument(
        "--txt",
        default="output/instagram_brand_search/following/shortlisted_bloggers_for_phase1.txt",
